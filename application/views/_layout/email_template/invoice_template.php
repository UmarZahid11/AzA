                ...
                <div class="centerCol col-lg-7 col-xl-6 col-md-10 col-sm-10 col-12" style="float: none;margin: 0 auto;">
                    <div class="invoice_template">
                        <div class="invoice_card" style="padding: 30px;background: #fff;box-shadow: 0 0 20px #00000021;border-radius: 30px;margin-bottom: 30px;">
                            ...
                            <h2 style="line-height: 1;margin: 0 0 10px;font-size: 55px;color: #80060a;font-weight: 700;margin-bottom: 0;"><?= $order_total ?></h2>
                            <p style="font-family: Avenir;font-size: 15px;color: #000;margin-bottom: 0;"><?= $order_detail['order_payment_status'] ? 'Paid' : 'Unpaid'; ?> <?= date("M d, Y", strtotime($order_detail['order_createdon'])) ?></p>
                            <hr>
                        ...
                        <div class="invoice_card" style="padding: 30px;background: #fff;box-shadow: 0 0 20px #00000021;border-radius: 30px;margin-bottom: 30px;">
                            <p style="font-family: Avenir;font-size: 15px;color: #000;margin-bottom: 0;">Recipt #<?= $order_detail['order_id'] ?></p>
                            ...
                            <ul class="recipt_detail recipt_detail2" style="margin: 0 0 20px;padding: 0;list-style-type: none;">
                                ...
                                <li style="display: flex;align-items: center;justify-content: space-between;margin-bottom: 10px;border-bottom: 1px solid #878787;">
                                    ...
                                    <span class="frst" style="font-weight: 700;color: #000000;"><?= $order_detail['membership_title'] ?>
                                    </span>
                                </li>
                                <li style="display: flex;align-items: center;justify-content: space-between;margin-bottom: 10px;border-bottom: 1px solid #878787;">
                                    <span class="frst" style="font-weight: 700;color: #000000;">Qty: &nbsp;</span>
                                    <span style="font-weight: 700;color: #000000;" class="frst"><?= $order_detail['order_quantity'] ?></span>
                                </li>
                                <li style="display: flex;align-items: center;justify-content: space-between;margin-bottom: 10px;border-bottom: 1px solid #878787;">
                                    <span style="font-weight: 700;color: #000000;" class="frst">Total: &nbsp;</span>
                                    <span style="font-weight: 700;color: #000000;" class="frst"><?= $order_total ?></span>
                                </li>
                            </ul>
