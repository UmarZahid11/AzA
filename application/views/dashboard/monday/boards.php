                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button data-fancybox data-animation-duration="700" data-src="#updateBoardModal<?= $boardData['id']; ?>" href="javascript:;" class="btn btn-outline-custom" data-toggle="tooltip" title="" data-bs-placement="top">
                                    ...
                                    <form class="deleteBoardForm" data-id="<?= $boardData['id']; ?>" action="javascript:;" novalidate>
                                        <input type="hidden" name="_token" value="<?= $this->csrf_token; ?>" />
                                        <input type="hidden" name="type" value="board" />
                                        <input type="hidden" name="id" value="<?= $boardData['id']; ?>" />
        ...
        $('.deleteBoardForm').on('submit', function(e) {
            ...
            new Promise((resolve, reject) => {
                jQuery.ajax({
                    ...
                    complete: function() {
                        $(button).attr('disabled', false);
                        $(button).html('<i class="fa fa-loader fa-trash"></i>');
                    }
                });
            }).then(
                function(response) {
