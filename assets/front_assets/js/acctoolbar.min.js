    ...
    (this.init = o || { link: "", contact: "", buttonPosition: "left", forceLang: "" }),
        (this.locale = {
            "he-IL": {
                ...
                btn_close: "×¡×’×•×¨",
                keyboard_root: "× ×™×•×•×˜ ×ž×§×œ×“×ª",
                disable_animattions: "×—×¡×™×ž×ª ×× ×™×ž×¦×™×•×ª",
                access_declaration: "×”×¦×”×¨×ª × ×’×™×©×•×ª",
                debug_contacts: "×“×•×•×— ×¢×œ ×‘×¢×™×™×ª × ×’×™×©×•×ª",
                reset_all_settings: "×‘×˜×œ × ×’×™×©×•×ª",
                image_without_alt: "×ª×ž×•× ×” ×œ×œ× ×ª×™××•×¨",
                contrast_block: { header: "× ×™×’×•×“×™×•×ª ×¦×‘×¢×™×", btn_monochrome: "×ª×¦×•×’×ª<br>×ž×•× ×•×›×¨×•×", btn_bright: "× ×™×’×•×“×™×•×ª<br>×‘×”×™×¨×”", btn_invert: "× ×™×’×•×“×™×•×ª<br>×”×¤×•×›×”" },
                text_block: { header: "×’×•×“×œ ×˜×§×¡×˜", btn_font_up: "×”×’×“×œ×ª<br>×’×•×¤×•×Ÿ", btn_font_down: "×”×§×˜× ×ª<br>×’×•×¤×•×Ÿ", btn_font_readable: "×’×•×¤×•×Ÿ<br>×§×¨×™×" },
                content_block: { header: "×”×“×’×©×ª ×ª×•×›×Ÿ", btn_underline_links: "×”×“×’×©×ª<br>×§×™×©×•×¨×™×", btn_underline_headers: "×”×“×’×©×ª<br>×›×•×ª×¨×•×ª", btn_images_titles: "×ª×™××•×¨<br>×œ×ª×ž×•× ×•×ª" },
                zoom_block: { header: "×”×’×“×œ×ª ×ª×¦×•×’×”", btn_cursor_white: "×¡×ž×Ÿ ×œ×‘×Ÿ<br>×’×“×•×œ", btn_cursor_black: "×¡×ž×Ÿ ×©×—×•×¨<br>×’×“×•×œ", btn_zoom_in: "×”×’×“×œ×ª<br>×ª×¦×•×’×”" },
            },
            "ru-RU": {
                btn_open: "ÐœÐµÐ½ÑŽ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¾ÑÑ‚Ð¸",
                btn_close: "Ð—Ð°ÐºÑ€Ñ‹Ñ‚ÑŒ",
                keyboard_root: "ÐÐ°Ð²Ð¸Ð³Ð°Ñ†Ð¸Ñ Ñ ÐºÐ»Ð°Ð²Ð¸Ð°Ñ‚ÑƒÑ€Ñ‹",
                disable_animattions: "Ð‘Ð»Ð¾ÐºÐ¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ð°Ð½Ð¸Ð¼Ð°Ñ†Ð¸ÑŽ",
                access_declaration: "Ð”ÐµÐºÐ»Ð°Ñ€Ð°Ñ†Ð¸Ñ Ð´Ð¾ÑÑ‚ÑƒÐ¿Ð½Ð¾ÑÑ‚Ð¸",
                debug_contacts: "Ð¡Ð¾Ð¾Ð±Ñ‰Ð¸Ñ‚ÑŒ Ð¾ Ð¿Ñ€Ð¾Ð±Ð»ÐµÐ¼Ðµ",
                reset_all_settings: "Ð¡Ð±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
                image_without_alt: "Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ Ð±ÐµÐ· Ñ‚ÐµÐºÑÑ‚Ð°",
                contrast_block: { header: "Ð¦Ð²ÐµÑ‚Ð¾Ð²Ð¾Ð¹ ÐºÐ¾Ð½Ñ‚Ñ€Ð°ÑÑ‚", btn_monochrome: "Ð¼Ð¾Ð½Ð¾Ñ…Ñ€. Ð´Ð¸ÑÐ¿Ð»ÐµÐ¹", btn_bright: "ÑÐ²ÐµÑ‚Ð»Ñ‹Ð¹ ÐºÐ¾Ð½Ñ‚Ñ€Ð°ÑÑ‚", btn_invert: "Ð¸Ð½Ð²ÐµÑ€Ñ‚. ÐºÐ¾Ð½Ñ‚Ñ€Ð°ÑÑ‚" },
                text_block: { header: "Ð Ð°Ð·Ð¼ÐµÑ€ Ñ‚ÐµÐºÑÑ‚Ð°", btn_font_up: "ÑƒÐ²ÐµÐ»Ð¸Ñ‡. ÑˆÑ€Ð¸Ñ„Ñ‚Ð°", btn_font_down: "ÑƒÐ¼ÐµÐ½ÑŒÑˆ. ÑˆÑ€Ð¸Ñ„Ñ‚Ð°", btn_font_readable: "Ñ‡Ð¸Ñ‚Ð°ÐµÐ¼Ñ‹Ð¹ ÑˆÑ€Ð¸Ñ„Ñ‚" },
                content_block: { header: "Ð’Ñ‹Ð´ÐµÐ»ÐµÐ½Ð¸Ðµ ÑÐ¾Ð´ÐµÑ€Ð¶Ð¸Ð¼Ð¾Ð³Ð¾", btn_underline_links: "Ð²Ñ‹Ð´ÐµÐ». ÑÑÑ‹Ð»ÐºÐ¸", btn_underline_headers: "Ð²Ñ‹Ð´ÐµÐ». Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐ¸", btn_images_titles: "Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ñ ÐºÐ°Ñ€Ñ‚Ð¸Ð½Ð¾Ðº" },
                zoom_block: { header: "Ð£Ð²ÐµÐ»Ð¸Ñ‡ÐµÐ½Ð¸Ðµ ÐºÐ¾Ð½Ñ‚ÐµÐ½Ñ‚Ð°", btn_cursor_white: "Ð±ÐµÐ»Ñ‹Ð¹ ÐºÑƒÑ€ÑÐ¾Ñ€", btn_cursor_black: "Ñ‡ÐµÑ€Ð½Ñ‹Ð¹ ÐºÑƒÑ€ÑÐ¾Ñ€", btn_zoom_in: "ÑƒÐ²ÐµÐ»Ð¸Ñ‡. Ð´Ð¸ÑÐ¿Ð»ÐµÑ" },
            },
            en: {
    ...
    (MicAccessTool.prototype.buildToolBox = function () {
        var o = this.currentLanguage || this.locale.en,
            A =
                ...
                '" id="mic-toolbox-contrast-hard"><span><img alt="× ×™×’×•×“×™×•×ª ×”×¤×•×›×”" src="data:image/png;base64,"> </span><span>' +
                o.contrast_block.btn_invert +
                ...
                '" id="mic-toolbox-link-nagishut" style="display:none" href="#" target="_blank">' +
                o.access_declaration +
